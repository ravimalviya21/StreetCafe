...
const UpdatePassWord = () =>
{
    ...
    useEffect(() => {
            lottie.loadAnimation({
                ...
                autoplay : true,
                renderer : 'svg',
                animationData : require('../../../Images/Animation/updatepassword.json')
            })
    }, [] )
                ...
                <div className="d-flex align-items-center justify-content-center">
                    <div className="d-flex justify-content-between flex-column">
                        ...
                        <div className="login-head">
                            <div className="display-4 text-capitalize">update password</div>
                        </div>
                        </div>
                        <div className="login-inner-container">
                            <form className="text-capitalize">
                                <div className="updatepass-inner-container d-flex flex-column justify-content-evenly">
                                    ...
                                    <div className="d-flex flex-column justify-content-evenly">
                                        ...
                                        <div onClick={() => navigate('/updatepassword') } className="login-button d-flex align-items-center justify-content-center text-white"><div>update password</div></div>
